...
export interface InsightFilterOptions {
  datePreset?: 'today' | 'yesterday' | 'this_week' | 'last_week' | 'this_month' | 'last_month' | 'last_3_months' | 'last_6_months' | 'this_quarter' | 'lifetime' | 'last_30d' | 'last_14d' | 'last_7d' | 'last_28d' | 'last30days';
  timeRange?: {
